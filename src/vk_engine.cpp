...
void VulkanEngine::init_vulkan()
{
    ...
    vkb::Result<vkb::Instance> instance = builder.set_app_name("AstraEngine")
    ...
    vkb::PhysicalDevice physicalDevice = selector
        ...
        .prefer_gpu_device_type(/*discrete*/)
        .select()
        .value();
...
void VulkanEngine::init_sync_structures()
{
    ...
    for (int i = 0; i < swapchainImageCount; i++) {
        ...
        _deletionQueue.push_function([=]() {
            ...
            }, "render_semaphores " + std::to_string(i));
    }
...
void VulkanEngine::draw()
{
    ...
    // remove frame-related resources
    ...
    //prepare present
    // this will put the image we just rendered to into the visible window.m
